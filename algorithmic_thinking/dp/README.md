...
问题的状态是一维 / 二维，但求解顺序是线性的（如从左到右、从短到长），状态转移无后效性

#### 一维 DP

- 💥[70. 爬楼梯](%5B70%5D爬楼梯.md)
- 💥[338. 比特位计数](%5B338%5D比特位计数.md)

#### 二维 DP

状态细分：用**第二维**记录“选/不选”等约束条件。

- 💥[121. 买卖股票的最佳时机](%5B121%5D买卖股票的最佳时机.md)

#### 区间 DP

状态定义为区间 `dp[i][j]`，从短区间到长区间求解，状态转移依赖更小的区间

- 💥[5. 最长回文子串](%5B5%5D最长回文子串.md)
